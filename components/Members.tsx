...
const MEMBERS: Member[] = [
  ...
  { index: '03', name: 'ГОША', role: 'Соло-гитара', photo: '/img/gosha.jpg?v=2', bio: 'Лезвие #1. Соло — контрольный выстрел в голову. Вдвоём с Костей они смертоносный дуэт.', quote: '«Два грифа — двойное кровопускание»' },
  { index: '04', name: 'КОСТЯ', role: 'Ритм-гитара', photo: '/img/kostya.jpg?v=2', bio: 'Лезвие #2. Гитарные рифы разрывают сцену. Плетёт звуковую паутину, из которой не выбраться.', quote: '«Рифф — удар хлыстом»' },
]
